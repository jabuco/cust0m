...
(function() {
  ...
  function Cb() {
    ...
    gb = function(a, c, d, h, i, j) {
      ...
      b
        ...
        : (k = new Aa(a, c, p(d, 1), p(h, 0), p(i, 0), p(j, 0)).getTime());
      return k;
    };
    rb = c + "Minutes";
    sb = c + "Hours";
    ...
    na = function(a) {
      ...
      (function(a) {
        a && a.stops
          ...
          : (c = Tb.exec(a))
          ? (b = [B(c[1]), B(c[2]), B(c[3]), parseFloat(c[4], 10)])
          : (c = Ub.exec(a))
          ? (b = [B(c[1], 16), B(c[2], 16), B(c[3], 16), 1])
          : (c = Vb.exec(a)) && (b = [B(c[1]), B(c[2]), B(c[3]), 1]);
      })(a);
      return {
        get: function(c) {
          var f;
  ...
  K.prototype = {
      ...
      if (f) {
        ...
        h[q]
          ...
          : ((g.id = a = "highcharts-" + yb++),
            ...
            m(j, function(a) {
              a[1].indexOf("rgba") === 0
                ? ((e = na(a[1])), (k = e.get("rgb")), (l = e.get("a")))
                : ((k = a[1]), (l = 1));
              a = d
                .createElement("stop")
    ...
    css: function(a) {
      ...
      if (e) {
        e = this.textWidth =
          (a && a.width && d.nodeName.toLowerCase() === "text" && B(a.width)) ||
          this.textWidth;
        b && (a = r(b, c));
        this.styles = a;
    ...
    getBBox: function(a) {
      ...
      d !== u &&
        ...
        (l =
          d === "" || Ob.test(d) ? "num:" + d.toString().length + l : d + l));
      l && !a && (b = c.cache[l]);
      if (!b) {
  ...
  ta.prototype = {
    ...
    init: function(a, b, c, d, e) {
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(A.createTextNode("Created with Highcharts 4.1.5"));
          ...
          m(e, function(e, f) {
            ...
            m(g, function(e) {
              if (e !== "" || g.length === 1) {
                ...
                i.test(e) &&
                  !d &&
                  (L(y, "onclick", 'location.href="' + e.match(i)[1] + '"'),
                  F(y, { cursor: "pointer" }));
                e = v(e.replace(/<(.|\n)*?>/g, "") || " ");
                if (e !== " ") {
                  ...
                  !n &&
                    f &&
                    (!ba && d && F(y, { display: "block" }), L(y, "dy", C(y)));
                  if (l) {
                    for (
                      var o = e.replace(/([^\^])-/g, "$1- ").split(" "),
                        m =
                          g.length > 1 ||
                          f ||
                          (o.length > 1 && k.whiteSpace !== "nowrap"),
                        S,
                        s,
                        ua,
                        u = [],
                        ...
                        q && s
                          ...
                          ? ((o = u),
                            ...
                            o.length &&
                              ...
                              b.appendChild(y)),
                            ua > l && (l = ua))
                          : (y.removeChild(y.firstChild), u.unshift(o.pop())),
                        o.length &&
                          y.appendChild(
                            A.createTextNode(o.join(" ").replace(/- /g, "-"))
                          );
    ...
    label: function(a, b, c, d, e, f, g, h, i) {
      ...
      function k() {
        ...
        if (b !== q.x || c !== q.y)
          q.attr("x", b),
            c !== u &&
              q.attr(q.element.nodeName === "SPAN" ? "y" : "translateY", c);
        q.x = b;
        q.y = c;
      }
      function l(a, b) {
    ...
    var Na = {
      ...
      color: function(a, b, c, d) {
        ...
        if (i) {
          ...
          m(a, function(a, b) {
            g.test(a[1])
              ? ((f = na(a[1])), (k = f.get("rgb")), (l = f.get("a")))
              : ((k = a[1]), (l = 1));
            fa.push(a[0] * 100 + "% " + k);
            b ? ((y = l), (p = k)) : ((q = l), (C = k));
          });
      ...
      if (n && C)
        s === "inside" && (C = -C),
          ...
          o
            ...
            : (this.mark = f
                .path(h)
                .attr({ stroke: v, "stroke-width": n, opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(w))
  ...
  va.prototype = {
    ...
    defaultLabelFormatter: function() {
      ...
      g === u &&
        (g = O(b) >= 1e4 ? w.numberFormat(b, 0) : w.numberFormat(b, -1, u, ""));
      return g;
    },
    ...
    renderUnsquish: function() {
        ...
        for (h = c.length; !f && h--; )
          if (((i = c[h]), (i = d[i].label)))
            if (
              ...
              i.getBBox().height > this.len / c.length - (g.h - g.f))
            )
      ...
      j.rotation &&
        (k = {
          width:
            (l > a.chartHeight * 0.5 ? a.chartHeight * 0.33 : a.chartHeight) +
            "px",
        ...
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({
              ...
              align:
                q.textAlign ||
                { low: "left", middle: "center", high: "right" }[q.align],
            })
    ...
    if (s(b)) {
      ...
      for (
        var d = i.getTime(),
          l = i[Ya](),
          n = i[Xa](),
          o = (G.day + (g ? Wa(i) : i.getTimezoneOffset() * 6e4)) % G.day;
        d < c;
    ...
    runPointActions: function(a) {
        ...
        : (m(c, function(b) {
          ...
          m(l, function(a) {
            if (
              ...
              s(a.plotY) &&
              (a.dist.distX < i ||
                ((a.dist.distX === i || a.series.kdDimensions > 1) &&
                  a.dist.distR < j))
            )
      ...
      if (n && (n !== f || (d && d.isHidden)))
        if (e && !n.series.noSharedTooltip) {
          for (h = l.length; h--; )
            (l[h].clientX !== n.clientX || l[h].series.noSharedTooltip) &&
              l.splice(h, 1);
      ...
      if (a)
        f.refresh(g),
          e &&
            ...
            m(c.axes, function(b) {
              p(b.options.crosshair && b.options.crosshair.snap, !0)
    ...
    drag: function(a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          f &&
          ((d -= n),
          this.selectionMarker.attr({ width: O(d), x: (d > 0 ? 0 : d) + n }));
        this.selectionMarker &&
          g &&
          ((d = e - o),
          this.selectionMarker.attr({ height: O(d), y: (d > 0 ? 0 : d) + o }));
      ...
      b.cancelClick ||
        (c && this.inClass(a.target, "highcharts-tracker")
          ...
          : (r(a, this.getCoordinates(a)),
            b.isInsidePlot(a.chartX - d, a.chartY - e) && M(b, "click", a)));
    },
  ...
  r(w.Pointer.prototype, {
    ...
    pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
      ...
      w
        ? ((t -= 0.8 * (t - g[j][0])), s || (x -= 0.8 * (x - g[j][1])), c())
        : (g[j] = [t, x]);
      C || ((f[j] = p - o), (f[n] = q));
      f = C ? 1 / m : m;
      e[n] = q;
  ...
  mb.prototype = {
    ...
    destroyItem: function(a) {
      var b = a.checkbox;
      m(["legendItem", "legendLine", "legendSymbol", "legendGroup"], function(
        b
      ) {
        a[b] && (a[b] = a[b].destroy());
      });
    ...
    renderItem: function(a) {
      ...
      if (!m) {
        ...
        a.legendItem = m = c
          .text(
            d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a),
            l ? f + g : -g,
            this.baseline || 0,
            r
          )
      ...
      c = m.getBBox();
      f = a.checkboxOffset =
        d.itemWidth || a.legendItemWidth || f + g + c.width + k + (v ? 20 : 0);
  ...
  D.prototype = {
    ...
    layOutTitles: function(a) {
      ...
      d &&
        ...
        !e.floating && !e.verticalAlign && (b = sa(b + d.getBBox().height)));
    ...
    cloneRenderTo: function(a) {
      var b = this.renderToClone,
        c = this.container;
      a
        ? b && (this.renderTo.appendChild(c), Ra(b), delete this.renderToClone)
    ...
    drawChartBox: function() {
      ...
      if (n)
        g
          ? g.animate(
              g.crisp({ x: q, y: p, width: m, height: s, strokeWidth: -n })
            )
          : (this.plotBorder = b
              .rect(q, p, m, s, 0, -n)
              .attr({
      ...
      getCenter: function() {
        ...
        for (h = 0; h < 4; ++h)
          (i = e[h]),
            ...
            (a = h < 2 || (h === 2 && g)),
            (e[h] =
              (g ? ([d, b, f, e[2]][h] * B(i)) / 100 : B(i)) + (a ? c : 0));
        return e;
      },
    }),
    Ga = function() {};
  ...
  Q.prototype = {
        ...
        if (o && h > o) {
          ...
          if (qa(k)) {
            ...
            if (s)
              ...
              for (c = 0; c < h; c++) (i = a[c]), (q[c] = i[0]), (y[c] = i[1]);
          else ka(12);
        } else
          for (c = 0; c < h; c++)
            if (
      ...
      for (n = 0; n < g; n++)
        (i = h + n),
          j
            ...
            : (b[i]
                ? (k = b[i])
                : a[i] !== u && (b[i] = k = new f().init(this, a[i], d[n])),
              (l[n] = k)),
          (l[n].index = i);
      if (b && (g !== (c = b.length) || j))
        for (n = 0; n < c; n++)
    ...
    translate: function() {
      ...
      for (
        ...
        n = m.low;
        var v =
          b && e.stacks[(this.negStacks && C < k ? "-" : "") + this.stackKey];
    ...
    setClip: function(a) {
      var b = this.chart,
        ...
        g =
          this.sharedClipKey ||
          ["_sharedClip", a && a.duration, a && a.easing, f.height].join(","),
        h = b[g],
        i = b[g + "m"];
      if (!h) {
        if (a)
          ...
          if (l) {
            ...
            if (!b.marker)
              f.color =
                f.color ||
                (!j.options.color &&
                  e[j.negative && h ? "negativeColor" : "color"]) ||
                na(j.color)
      ...
      m(c, function(c, i) {
        ...
        if (k) db(k), k.animate({ d: f });
          ...
          (k = { stroke: c[1], "stroke-width": d, fill: g, zIndex: 1 }),
            c[2]
              ? (k.dashstyle = c[2])
              : e && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"),
        ...
        i && i.hide(),
          ...
          m(d, function(d, m) {
            ...
            b.inverted &&
              c.isVML &&
              (h = l.isXAxis
                ? { x: 0, y: n ? e : f, height: h.width, width: b.chartWidth }
                : {
      ...
      function b(a, h, i, j) {
        ...
        h[n] &&
          ...
          h[k] &&
            ...
            ((a = b(a, h[k], i + 1, j)), (o = a.dist[d] < o.dist[d] ? a : o)));
        return o;
      }
      var c = this,
        d = this.kdComparer,
      ...
      for (s = 0; s < d; s++) {
        ...
        e === "percent"
          ? ((o = o ? h : i),
            j && l[o] && l[o][r]
              ? ((o = l[o][r]),
                (m.total = o.total = t(o.total, m.total) + O(v) || 0))
  ...
  r(Q.prototype, {
    addPoint: function(a, b, c, d) {
      ...
      c &&
        (g[0] && g[0].remove
          ? g[0].remove(!1)
          : (g.shift(), e.updateParallelArrays(i, "shift"), h.shift()));
      e.isDirty = !0;
      e.isDirtyData = !0;
      ...
      b.grouping === !1
        ...
        : m(a.chart.series, function(b) {
            ...
            if (
              ...
              c.stacking
                ? ((f = b.stackKey), g[f] === u && (g[f] = i++), (h = g[f]))
                : c.grouping !== !1 && (h = i++),
                (b.columnIndex = h);
          });
      var c = I(
      ...
      m(a.points, function(h) {
        ...
        if (i !== u && !isNaN(i) && h.y !== null)
          (f = h.shapeArgs),
            ...
            j
              ? (db(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](z(f)))
      ...
      setVisible: function(a, b) {
        ...
        if (a !== c.visible || b)
          if (
            ...
            m(["graphic", "dataLabel", "connector", "shadowGroup"], function(
              b
            ) {
  ...
  if (J.pie)
    (J.pie.prototype.drawDataLabels = function() {
        ...
        for (G = 2; G--; ) {
          ...
          if (L) {
            ...
            for (E = 0; E < L; E++) {
              ...
              A = e.justify
                ? o[0] + (G ? -1 : 1) * (q + n)
                : a.getX(B === r - q - n || B === r + q + n ? c : B, G);
              u._attr = { visibility: D, align: w[6] };
              u._pos = {
                x: A + e.x + ({ left: f, right: -f }[w[6]] || 0),
                y: B + e.y - 10,
              };
              u.connX = A;
              u.connY = B;
              if (this.options.size === null)
                (v = u.width),
                  A - v < f
                    ? (F[3] = t(x(v - A + f), F[3]))
                    : A + v > h - f && (F[1] = t(x(A + v - h + f), F[1])),
                  B - b / 2 < 0
                    ? (F[0] = t(x(-B + b / 2), F[0]))
                    : B + b / 2 > i && (F[2] = t(x(B + b / 2 - i), F[2]));
            }
          }
        }
              ...
              m(this.points, function(b) {
                ...
                if ((u = b.dataLabel) && u._pos)
                  (D = u._attr.visibility),
                    ...
                    j
                      ? (j.animate({ d: k }), j.attr("visibility", D))
      ...
      (J.pie.prototype.verifyDataLabelOverflow = function(a) {
        ...
        d[0] !== null
          ? (e = t(b[2] - t(a[1], a[3]), c))
          : ((e = t(b[2] - a[1] - a[3], c)), (b[0] += (a[3] - a[1]) / 2));
        d[1] !== null
          ? (e = t(I(e, b[2] - t(a[0], a[2])), c))
          : ((e = t(I(e, b[2] - a[0] - a[2]), c)), (b[1] += (a[0] - a[2]) / 2));
        e < b[2]
          ? ((b[2] = e),
            this.translate(b),
            m(this.points, function(a) {
      ...
      if (
        ...
        if (this.graphic)
          (g = g && this.graphic.symbolName && p.r),
            this.graphic.attr(
              z(p, g ? { x: c - g, y: d - g, width: 2 * g, height: 2 * g } : {})
            ),
            k && k.hide();
        else {
          if (a && i)
...
$(".user-info.user-only").prepend(
  '<div class="cust0m_benis_graph"><div class="cust0m_benis_graph_inner" id="cust0m_benis_graph"></div></div><div class="cust0m_settings"><div class="cust0m_version">V2.1</div> \r\n' +
...
$("#user-profile-name").after(
  '<div class="cust0m_benis_head">mm</div><div class="cust0m_benis_num"></div>'
);

/* und dann Kommen auch schon die "Best of" und "Bullshit" Buttons*/
$("#tab-stalk").after(
  '<a id="tab-best_of" class="head-tab cust0m_best_of" onclick="cust0m.load_best_of();">mm </a><a id="tab-bullshit" class="head-tab cust0m_bullshit" onclick="cust0m.load_bullshit();">mm </a>'
);
...
function save_options() {
  set = {
    ...
    kommentarklappen_default: $(
      "#cust0m_input_kommentarklappen_default"
    ).text(),
  ...
  for (var k in set) {
    if (standard[k + "_min"] != undefined) {
      ...
      set[k] = Math.max(
        standard[k + "_min"],
        Math.min(standard[k + "_max"], parseInt(set[k]))
      );
    }
  }
...
function restore_options() {
  chrome.storage.local.get(standard, function(items) {
    ...
    for (i = 0; i < options.length; i++) {
      ...
      if (items[option] == "ON")
        $("#cust0m_input_" + option + " .cust0m_trigger_on").addClass("active");
      else if (items[option] == "M 1")
        $("#cust0m_input_" + option + " .cust0m_trigger_m1").addClass("active");
      else if (items[option] == "M 2")
        $("#cust0m_input_" + option + " .cust0m_trigger_m2").addClass("active");
      else if (items[option] == "M 3")
        $("#cust0m_input_" + option + " .cust0m_trigger_m3").addClass("active");
      else
        $("#cust0m_input_" + option + " .cust0m_trigger_off").addClass(
          "active"
        );
    }
    $("#cust0m_input_kommentarklappen_default").html(
      items.kommentarklappen_default
    );
...
$("#settings-link").mouseout(function() {
  $(".cust0m_settings").css("display", "none");
});
$("#settings-link").mouseover(function() {
  $(".cust0m_settings").css("display", "block");
});

$(".cust0m_benis_head, .cust0m_benis_num").mouseout(function() {
  $(".cust0m_benis_graph").css("display", "none");
});
$(".cust0m_benis_head, .cust0m_benis_num").mouseover(function() {
  $(".cust0m_benis_graph").css("display", "block");
});
...
function update_settings() {
  chrome.storage.local.get(standard, function(items) {
    ...
    g.text =
      ...
      (items.fullsize == "ON") +
      ";" +
      "cust0m.kommentarklappen = " +
      (items.kommentarklappen == "ON") +
      ";" +
      "cust0m.kommentarklappen_default = " +
      items.kommentarklappen_default +
      ";" +
      "cust0m.op_top = " +
      (items.op_top == "ON") +
      ";" +
      "cust0m.best_of_benis = " +
      best_of_benis +
      ";" +
      "cust0m.bullshit_benis = " +
      bullshit_benis +
      ";" +
      "CONFIG.TAGS_MAX_DISPLAY = " +
      items.start_tags +
      ";" +
      "CONFIG.LAYOUT.THUMBS_PER_ROW.MAX = " +
      anzahl +
      "; CONFIG.LAYOUT.THUMB.WIDTH = " +
      128 * thumbs +
      "; CONFIG.LAYOUT.THUMB.HEIGHT = " +
      128 * thumbs +
      "; cust0m.refresh(); cust0m.LoadEinklappen();";
    s.parentNode.insertBefore(g, s);
    ...
    changeCss(
      "a.thumb, a.thumb img",
      "height: " + 128 * thumbs + "px; width: " + 128 * thumbs + "px;"
    );
    ...
    if (items.pos == "ON") {
      $(window)
        ...
        .resize(function(event) {
          changeCss(
            "div.item-comments, div.item-info",
            "margin: auto; max-width: 1052px;"
          );
        });
    } else {
      $(window)
    ...
    if (items.ups_downs == "ON") {
      $(window)
        ...
        .resize(function(event) {
          changeCss(
            ".cust0m_item_info, .cust0m_item_info_bar",
            "display: block"
          );
        });
    } else {
    ...
    if (items.pfeil == "ON") {
      $(window)
        ...
        .resize(function(event) {
          changeCss(
            ".stream-prev-icon, .stream-next-icon",
            "display: none !important"
          );
          changeCss(
            ".cust0m_stream-prev-icon, .cust0m_stream-next-icon",
    ...
    if (items.save_views == "OFF") {
      ...
      $(window)
        ...
        .resize(function(event) {
          changeCss(
            ".custom_seen",
            "opacity: " + (1 - items.save_views_opacity / 100)
          );
          changeCss(".custom_seen::after", "");
        });
      ...
      $(window)
        ...
        .resize(function(event) {
          ...
          changeCss(
            ".custom_seen::after",
            "background: rgba(137, 43, 43, " +
              items.save_views_opacity / 100 +
              ');    content: "";    width: 100%;    height: 100%;    margin: -150% 0 0 90%;    display: block;  transform: rotate(45deg);'
          );
        });
      ...
      $(window)
        ...
        .resize(function(event) {
          ...
          changeCss(
            ".custom_seen::after",
            "content: \"v\";height: 20px;margin: -18px 0 0 -5px;padding-right: 3px;display: block;transform: rotate(0deg);color: #FFF;font-family: 'pict0gramm';text-shadow: 0 0 1px #000, 0 0 2px #000;text-align: right;opacity: " +
              items.save_views_opacity / 100 +
              ";"
          );
        });
...
function setViews() {
  if (
    views.save_views != "OFF" &&
    (lastViewed == 0 ||
      lastViewed != $(".custom_seen").length ||
      lastThumbs != $(".thumb").length)
  ) {
    $("#cust0m_viewed div").each(function(id, elem) {
      if ($(elem).attr("view") != undefined) {
        saveView("item-" + $(elem).attr("view"));
      }
    });
    ...
    $(".thumb")
      ...
      .each(function(id, elem) {
        if (isView($(elem).attr("id"))) $(elem).addClass("custom_seen");
...
load_benis_graph = function() {
  ...
  while (benis_graph_time < now && rounds < 102) {
    ...
    benis_graph.shift();
    benis_graph.push(
      benis_graph[benis_graph.length - 1] != null
        ? benis_graph[benis_graph.length - 1]
        : benis
    );
    rounds++;
  }
  ...
  chrome.storage.local.set({
    benis_graph: benis_graph,
    benis_graph_time: benis_graph_time,
  });
